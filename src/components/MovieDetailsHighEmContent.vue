...
export default {
  ...
  data() {
    ...
    created() {
     axios.get(`https://api.themoviedb.org/3/movie/${this.movieIdAgain}?api_key=51c374b022c8809f8ebb065eaa0a82f6&language=en-US`)
      .then((response) => {
        console.log(response)
        this.movieDetails = response.data
        this.movieImgPath = this.movieDetails.backdrop_path
        return axios.get(`https://image.tmdb.org/t/p/original/${this.movieImgPath}`)
      }) 
      .then((info) => {
