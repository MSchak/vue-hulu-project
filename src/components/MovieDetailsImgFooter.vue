<template>
  <div class="details-footer row align-content-center">
    <div class="high-em-color col ms-4 ms-lg-5 p-0">
      <p class="m-0 stars">
        <strong>Starring:</strong> {{ starOne }}, {{ starTwo }}, {{ starThree }}
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${this.movieIdAgain}/credits?api_key=51c374b022c8809f8ebb065eaa0a82f6&language=en-US`
      )
      .then((response) => {
